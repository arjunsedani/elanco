/* eslint-disable */
/*
 * This is a util test script that emulates the functionalities of Slingshot API
 * Changes made:
 *    a. export sls to be able to use in test setup - line 1310
 *    b. mock getWsUri to always return wss://mockURL.com to allow websocket server mocking - line 393
 *    c. comment out unnecessary alert() to minimise noise in the log - line 54 - 56
 *    d. comment out sls.Utils method that are irrelevant for cypress tests - line 58 - 66
 *    e. comment out unnecessary child removal to minimise noise in the log - line 302 - 304
 */
...
Array.prototype.indexOf ||
  ...
  (sls.InsertRequest.prototype.serialize = function () {
    for (
      var s = `${this.service},${this.name},${this.type},${this.seqNo}`, t = 0;
  ...
  (sls.HttpConnection = function (s, t, e, i, n) {
    (sls.HttpConnection.prototype.request_record = function (s) {
      ...
      (sls.HttpConnection.prototype.destroy = function () {
        null !== this._websocket ? this._websocket.close() : this.sendClose();
      ...
      (sls.HttpConnection.prototype.connHdr = function () {
        return this._bandwidth <= 0
          ...
          : `1${this._sig},${this._id},${2 & this._flags},${this._bandwidth}\n`;
      }),
