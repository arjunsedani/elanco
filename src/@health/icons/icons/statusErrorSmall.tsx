 ...
 */
const StatusErrorSmall = React.forwardRef<SVGSVGElement, StyledSvgProps>(
  (props, ref) => {
    warnDeprecated([props.name, "statusErrorSmall", "statusError"]);
    return (
      <StyledSVG
        ref={ref}
        width="24px"
...
export default StatusErrorSmall;
